...
```bash
codex plugin marketplace add Cratis/AI.Distribution --ref v0.3.0
...
```bash
gemini extensions install https://github.com/Cratis/AI.Distribution --ref v0.3.0
```
...
```bash
pi install git:github.com/Cratis/AI.Distribution@v0.3.0
```
